...
//            list.get(i).setQiangdawentichengji(Double.parseDouble(pingyuewentiList.get(0).get("pingfen")+""));
        ...
        for (int i = 0; i <list.size() ; i++) {
            ...
            List<HashMap> pingyuewentiList = new CommDAO().select("select * from pingyuewenti where qiangdaren= " + xuehao);
            Double pingjun = 0D;
